...
5. Download the `wso2-obiam-toolkit-berlin-1.0.0.zip` file and extract it to the `<IS_HOME>` directory.
6. Download the latest updates for `wso2-obiam-toolkit-berlin-1.0.0`. For more information, see [Getting WSO2 Updates](../setting-up-servers.md#getting-wso2-updates).
