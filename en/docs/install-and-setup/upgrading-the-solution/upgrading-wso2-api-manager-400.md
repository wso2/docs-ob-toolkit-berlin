...
## Set up Open Banking Accelerator and Berlin Toolkit for API Manager
 ...
 5. Download the latest updates for `wso2-obam-toolkit-berlin-1.0.0`. For more information, see [Getting WSO2 Updates](../setting-up-servers.md#getting-wso2-updates).
