This page explains how to configure WSO2 Identity Server as the Key Manager.

## Sign in to the Identity Server

1. Go to the Admin Portal of API Manager at `https://<APIM_HOST>:9443/admin`.
2. Use the default super admin credentials and sign in.
    - Username: admin@wso2.com
    - Password: wso2123

## Add New Key Manager

1. Go to **Key Manager** on the left main menu. ![add_Key_Manager](../assets/img/get-started/quick-start-guide/add_Key_Manager.png)
2. Click **Add New Key Manager** and configure Key Manager. 
